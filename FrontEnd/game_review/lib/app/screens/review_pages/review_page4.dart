...
class ReviewPage4 extends StatefulWidget {
  const ReviewPage4({ Key? key }) : super(key: key);

  @override
  State<ReviewPage4> createState() => _ReviewPage4State();
}

class _ReviewPage4State extends State<ReviewPage4> {
  List<Review> reviews = [];
    ...
    child: Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          if(_firstPress){
            _firstPress = false ;
          NetworkHelper helper = NetworkHelper(url:"http://localhost:8080/games/5");
