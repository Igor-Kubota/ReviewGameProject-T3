...
import 'package:game_review/app/screens/review_pages/review_page3.dart';
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        flex: 34,
                        child: Image.asset(
                          'assets/images/minecraft_capa_v1.png',
                      ...
                      Expanded(
                        flex: 15,
                        child: Text(
                          "Developer: " + items[index+2].developer.toString(),
                          style: TextStyle(
                          fontSize: 20,
                      ...
                      Expanded(
                        flex: 15,
                        child: Text(
                          "Genre: " + items[index+2].genre.toString(),
                          style: TextStyle(
                          fontSize: 20,
                          color: Colors.blueGrey.shade200,
                        )
                      ...
                      Expanded(
                        flex: 15,
                        child: Text(
                          "Score: " + items[index+2].score.toString(),
                          style: TextStyle(
                          fontSize: 20,
                          color: Colors.blueGrey.shade200,
                        )
                      ...
                      Expanded(
                        flex: 15,
                        child: Text(
                          "Release Date: "+ items[index+2].release.toString(),
                          style: TextStyle(
                          fontSize: 20,
                          color: Colors.blueGrey.shade200,
                        )
                      ...
                      Expanded(
                        flex: 15,
                        child: Text(
                          "Platform: "+ items[index+2].consoles.toString(),
                          style: TextStyle(
                          fontSize: 20,
                          color: Colors.blueGrey.shade200,
                          )
